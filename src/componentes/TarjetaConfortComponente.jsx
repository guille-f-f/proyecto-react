    ...
    <div>
      <div className="contenedor_tarjetas">
        <div className="seccion">
          ...
          <p>
            Contamos con especialistas trabajando para que encuentres el confort
            en cada pisada. Nuestras zapatillas se amoldan a cada pie!
          </p>
        </div>
        <div className="seccion">
          <Link to="*">
          ...
          <p>
            Ampliamos nuestro catálogo de materiales para incluir elementos
            reciclados y naturales. Juntos en la lucha por salvar nuestro
            planeta!
          </p>
        </div>
        <div className="seccion">
          ...
          <p>
            Podrás encontrar calzado para cada deporte para que cuentes con
            comodidad y excelencia en todos los pasos que des!
          </p>
        </div>
        <div className="seccion">
          <Link to="*">
          ...
          <p>
            Desde 1949 creando buenos productos, durables, cómodos y con un
            diseño atractivo!
          </p>
        </div>
      </div>
